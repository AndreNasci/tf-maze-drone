...
def main():
    ...
    df_log_1.to_csv(f"logs/06-hist-env/{description}-combination_{combination}-epsilon_{epsilon_option}-gamma_{gamma_option}-buffer_{buffer_option}-lr_{lr_option}.csv", index=None, header=True)
