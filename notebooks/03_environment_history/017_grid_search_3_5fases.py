...
# Variando Buffer
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 1 3 2 1 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 1 3 2 2 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 1 3 2 3 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 1 3 2 4 0

# Combination 2
# Variando Epsilon
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 2 0 0 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 2 1 0 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 2 2 0 0

# Variando Gamma
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 1 2 0 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 2 2 0 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 3 2 0 0

# Variando Buffer
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 0 2 1 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 0 2 2 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 0 2 3 0
./maze-drone-v03/bin/python 016_grid_search_3_3fases.py 2 0 2 4 0
'''
...
def main():
    ...
    print("Epsilon:",epsilon_option)
    print("Buffer:",buffer_option)
    print("LR:",lr_option)
    ...
    # TRAINING
    step_log, returns, finished, crashed, stucked, steped, log_loss, _, agent = session.train(without_wall_training=True, early_stop="finished")
    ...
    # TRAINING
    step_log, returns, finished, crashed, stucked, steped, log_loss, _, agent = session.train(without_wall_training=False, early_stop="finished")
    ...
    print("\n========================================================================== Training PHASE 3:")
    # Essa fase consiste em um ajuste fino
    ...
    # LOGGING
    df_log_3 = pd.DataFrame({'Step': step_log, 'Average Return': returns, '% Finished': finished, 'Crash Counter': crashed, 'Stuck Counter': stucked, 'Avg Steps/Episode': steped, 'Loss log': log_loss})
    ...
    # LOGGING
    df_log_4 = pd.DataFrame({'Step': step_log, 'Average Return': returns, '% Finished': finished, 'Crash Counter': crashed, 'Stuck Counter': stucked, 'Avg Steps/Episode': steped, 'Loss log': log_loss})


    print("\n========================================================================== Training PHASE 5:")
    # Essa fase consiste em um ajuste fino

    check_4 = agent.train_step_counter.numpy()
    ...
    # LOGGING
    df_log_5 = pd.DataFrame({'Step': step_log, 'Average Return': returns, '% Finished': finished, 'Crash Counter': crashed, 'Stuck Counter': stucked, 'Avg Steps/Episode': steped, 'Loss log': log_loss})



    df_log = pd.concat([df_log_1, df_log_2, df_log_3, df_log_4, df_log_5])
    ...
    print("Fase 2 terminada em", check_2)
    print("Fase 3 terminada em", check_3)
    print("Fase 4 terminada em", check_4)
    print()
